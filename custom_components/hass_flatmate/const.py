...
FRONTEND_SHOPPING_COMPACT_CARD_FILENAME = "hass-flatmate-shopping-compact-card.js"
...
FRONTEND_SHOPPING_COMPACT_CARD_RESOURCE_URL = (
    f"{FRONTEND_STATIC_PATH}/{FRONTEND_SHOPPING_COMPACT_CARD_FILENAME}"
)
...
FRONTEND_SHOPPING_COMPACT_CARD_RESOURCE_TYPE = "module"
...
SERVICE_ATTR_COMPLETED_BY_MEMBER_ID = "completed_by_member_id"
